...
--total purch amount of all orders
SELECT sum(purch_amt) FROM orders;

--avg purch amount of all orders
SELECT avg(purch_amt) FROM orders;

--amount of customers w/ names
SELECT count(cust_name) FROM customers;

--min purch amount of all orders
SELECT min(purch_amt) FROM orders;

--customer all info w/ name ends with b
...
--customers all info where order w/ purch amount >10
SELECT * FROM customers
...
--all customers who listed their names
SELECT * FROM customers
WHERE cust_name is NOT NULL;

--max grade of all customers
